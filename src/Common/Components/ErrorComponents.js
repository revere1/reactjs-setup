...
import { withProps } from './Composer';
...
const getLabel = intl => (id, defaultMessage) =>
  intl.formatMessage({ id, defaultMessage });

const ErrorComponent = ({ intl, btnTxt, error, status }) => {
      ...
      <table>
        <tr>
          ...
          <td>
            ...
            {/* {label('scc.rp.label.dp', 'Data Points')} */}
          </td>
        </tr>
      </table>
    </div>
...
const Error403 = injectIntl(withProps(error403)(ErrorComponent));
const Error404 = injectIntl(withProps(error404)(ErrorComponent));
